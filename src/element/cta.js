...
function Cta() {
  return (
    <>
      <section style={{backgroundImage:`url(${bg1})`, backgroundSize:"cover"}}>
			<div className="container">
				<div className="row action-box style-1 align-items-center">
					...
					<div className="col-xl-5 col-lg-4 col-md-4 text-right m-b30 wow fadeIn" data-wow-duration="2s" data-wow-delay="0.4s">
						<a href="contact-us-1"><a  className="btn btn-link d-inline-flex align-items-center"><i className="fa fa-angle-right m-r10"></i>Join Now</a></a>
					</div>
				</div>
			</div>
		</section>
