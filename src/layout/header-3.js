                    ...
                    <div className="container clearfix">
                        ...
                        <div className="extra-nav">
                            <div className="extra-cell">
                                <a href="contact-us-1"><a className="btn btn-corner gradient btn-primary"><i className="fa fa-angle-right m-r10"></i>Get A Quote</a></a>
                            </div>
                        </div>
                        <div className={`header-nav navbar-collapse collapse justify-content-end ${show ? "show" : ""}`} id="navbarNavDropdown">
                            <div className="logo-header">
                                <a href="/"><a><img src="images/logo.png" alt=""/></a></a>
                            </div>
